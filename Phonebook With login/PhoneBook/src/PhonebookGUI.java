...
public class PhonebookGUI extends JFrame {
    ...
    public PhonebookGUI() {
        ...
        contactDisplay = new JTextArea(35, 30);
        contactDisplay.setEditable(false);
        JScrollPane contactScrollPane = new JScrollPane(contactDisplay);
        contactDisplay.setFont(new Font("Times New Roman", Font.BOLD, 16)); // Set text color to black and bold
        contactDisplay.setForeground(Color.BLACK); // Set text color to black
    ...
    private boolean showLogin() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            // Implement your authentication logic here (e.g., check against a predefined username and password).
            // For demonstration purposes, we use a simple hardcoded example.
            if (username.equals("Safwan") && password.equals("1960")) {
    ...
    private void displayMainMenu() {
        ...
        welcomeLabel.setFont(new Font("Serif", Font.BOLD, 46));
    ...
    private void displayAddContactForm() {
        JPanel addContactPanel = new JPanel(new GridLayout(8, 8));
    ...
    private void displayEditContactDialog(Contact contact) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            contact.setPhone(Long.parseLong(phoneField.getText())); // Convert to long
